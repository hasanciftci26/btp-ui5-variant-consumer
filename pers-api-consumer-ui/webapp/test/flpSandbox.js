		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Personalization API Consumer UI",
									"targetURL": "#cftchsnpersapiconsumerui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cftchsnpersapiconsumerui-display": {
								"semanticObject": "cftchsnpersapiconsumerui",
								"action": "display",
								"description": "Personalization API Consumer UI",
								"title": "Personalization API Consumer UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cftc.hsn.persapiconsumerui",
									"url": sap.ui.require.toUrl("cftc/hsn/persapiconsumerui")
								}
							}
						}
					}
